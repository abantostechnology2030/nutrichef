...
- **El plan y la despensa están unidos por la VENTANA, no por el periodo (2026-07-30).** Botón **"🧺 Ver mi despensa"** en el plan → abre `despensa.html?inicio=&fin=` con **la semana que estás viendo**.
  ...
  - Con una ventana que no es la semana actual, la etiqueta dice **"esa semana −X%"** (no "esta"), el banner anuncia de qué semana son los números con un enlace de vuelta, y la pestaña de compra **arranca en esa semana** (vienes de ver qué te falta ahí).
